...
- [ ] Security: Strict isolation, JWT integrity, K8s namespace, and
...
- [ ] Reliability: Error handling (401, 404, 500), health checks,
...
- [ ] Reproducibility: All infra as code (Dockerfiles, Helm charts,
